...
<div class="container">
        ...
        <form action="http://127.0.0.1/dailycart3/product/editProduct/{$product.id}" method="POST" enctype="multipart/form-data">



            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Name </label>
                <input type="text" placeholder="{$product.name}" class="form-control" id="exampleInputEmail1" 
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="{$product.description}" class="form-control" id="exampleInputEmail1" 
            ...
            <div class="mb-3">
                ...
                <input type="number" placeholder="{$product.price}" class="form-control" id="exampleInputEmail1" 
